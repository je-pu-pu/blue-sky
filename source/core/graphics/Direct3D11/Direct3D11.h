...
private:
	...
	common::auto_ptr< Fader >				fader_; ///< @todo GraphicsManager に移行する
...
public:
	...
	inline Fader* getFader() { return fader_.get(); } ///< @todo GraphicsManager に移行する
	...
	inline const Fader* getFader() const { return fader_.get(); } ///< @todo GraphicsManager に移行する
