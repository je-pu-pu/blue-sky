...
public:
	...
	inline void set_x( UnitType v ) { DirectX::XMVectorSetX( value_, v ); }
	inline void set_y( UnitType v ) { DirectX::XMVectorSetY( value_, v ); }
	inline void set_z( UnitType v ) { DirectX::XMVectorSetZ( value_, v ); }
	inline void set_w( UnitType v ) { DirectX::XMVectorSetW( value_, v ); }

	void set( UnitType x, UnitType y, UnitType z, UnitType w = 1 )
	{
