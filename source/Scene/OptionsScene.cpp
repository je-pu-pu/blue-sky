...
void OptionsScene::render()
{
	...
	ui_renderer_.draw_text( title_x, title_y, content_w, 120.f, "OPTIONS", Color( 1.f, 1.f, 1.f, 1.f ), Color::Black, 3.f );
	...
	{
		ui_renderer_.draw_text( hint_x, hint_y, content_w, 90.f, "Arrow/AD Change    ESC Back", Color( 0.5f, 0.5f, 0.5f, 1.f ), Color::Black, 3.f );
	}
	else if ( selected == volume_index_ || selected == mouse_sens_index_ || selected == fov_index_ )
	{
		ui_renderer_.draw_text( hint_x, hint_y, content_w, 90.f, "Arrow/AD Adjust    ESC Back", Color( 0.5f, 0.5f, 0.5f, 1.f ), Color::Black, 3.f );
	}
	else if ( selected == mute_index_ || selected == fullscreen_index_ )
	{
		ui_renderer_.draw_text( hint_x, hint_y, content_w, 90.f, "Enter/Click Toggle    ESC Back", Color( 0.5f, 0.5f, 0.5f, 1.f ), Color::Black, 3.f );
	}
	else
	{
		ui_renderer_.draw_text( hint_x, hint_y, content_w, 90.f, "Enter/Click Select    ESC Back", Color( 0.5f, 0.5f, 0.5f, 1.f ), Color::Black, 3.f );
	}
}
